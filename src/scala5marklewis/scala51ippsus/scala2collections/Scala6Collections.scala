...
object Scala6Collections {
  ...
  private def twoCollectionMethods(a: Array[Int]): Unit = {
  ...
  private def zipMethods(a: Array[Int], lst: List[String]): Unit = {
  ...
  private def arithmeticMethods(a: Array[Int], lst: List[String]): Unit = {
  ...
  private def selectionMethods(a: Array[Int]): Unit = {
  ...
  private def headAndTailMethods(a: Array[Int]): Unit = {
  ...
  private def lastAndInitMethods(a: Array[Int]): Unit = {
  ...
  private def takeAndDropMethods(a: Array[Int]): Unit = {
  ...
  private def booleanMethods(a: Array[Int]): Unit = {
